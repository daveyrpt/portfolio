...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Davey Rupert
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Efficient software developer skilled in multiple languages, focused on user-friendly solutions.</p>
